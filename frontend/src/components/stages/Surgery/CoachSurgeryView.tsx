                                ...
                                <AnimatePresence mode="popLayout">
                                    {surgeryChunks.filter(c => !c.isRemoved).map(c => (
                                        <motion.div 
                                            ...
                                            className={`text-3xl md:text-4xl font-serif font-bold px-2 py-1 rounded-xl transition-all ${
                                                c.type === 'modifier' && isTeacherInteractive 
                    ...
                    >
                        ...
                        <div className="grid grid-cols-3 gap-2 mb-3">
                            <button 
                                ...
                                className={`py-3 rounded-xl font-bold text-sm flex flex-col items-center gap-1 transition-all ${
                                    surgeryMode === 'observation'
                                        ? 'shadow-md'
