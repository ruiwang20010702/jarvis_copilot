...
class AIService:
    ...
    def _generate_gemini(self, prompt: str, system_prompt: Optional[str] = None) -> str:
        ...
        # Gemini 3 configuration using new SDK types
        ...
        try:
            ...
            print(f"Gemini 3 generation failed: {e}, falling back to gemini-2.0-flash")
            # Fallback to a stable model if 3.0 fails
            try:
                response = self.gemini_client.models.generate_content(
